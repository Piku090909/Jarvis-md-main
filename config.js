...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || 'ALEX-PIKU;PIKU;https://qu.ax/ZfXCR.jpg',
  ...
  SESSION_ID: process.env.SESSION_ID || 'Jarvis_5x30_yxv4_006x_vv5x_80v5_7y53_4w61_04x1',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "ALEX-PIKU", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://qu.ax/ZfXCR.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis", "showAdAttribution": true}`,
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ʟɪꜱᴛ ᴍᴇɴᴜ;ALEX-PIKU;https://qu.ax/ZfXCR.jpg',
  ...
  STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*WAOO SAI TOO STATUS TA*",
  ...
  BOT_INFO: process.env.BOT_INFO || 'PIKU;ALEX-PIKU;https://qu.ax/ZfXCR.jpg',
